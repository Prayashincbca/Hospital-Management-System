        ...
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption sfl tp-resizeme" 
                ...
                data-endspeed="300"
                style="z-index: 5; font-size:50px; font-weight:500; color:#FFFFFF;  max-width: auto; max-height: auto; white-space: nowrap;">Hospital Management System</div>
            ...
            <div class="tp-caption sfr tp-resizeme" 
                ...
                data-endspeed="300" 
                style="z-index: 6; font-size:40px; color:#FFFFFF; font-weight:500; white-space: nowrap;">We care about your health </div>
            ...
            <div class="tp-caption sfb tp-resizeme" 
                ...
                data-endelementdelay="0.1" 
                data-endspeed="300" 
                style="z-index: 7;  font-size:22px; color:#FFFFFF; font-weight:500; max-width: auto; max-height: auto; white-space: nowrap;">Best Hospitality Services in your town</div>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption sfl tp-resizeme" 
                ...
                data-endelementdelay="0.4" 
                data-endspeed="300"
                style="z-index: 5; font-size:40px; font-weight:500; color:#FFFFFF;  max-width: auto; max-height: auto; white-space: nowrap;">Best Diagnostic Centre </div>
            ...
            <div class="tp-caption sfr tp-resizeme" 
                ...
                data-endelementdelay="0.4" 
                data-endspeed="300"
                style="z-index: 5; font-size:55px; font-weight:500; color:#FFFFFF;  max-width: auto; max-height: auto; white-space: nowrap;">Care And Cure</div>
            ...
            <div class="tp-caption sfb tp-resizeme" 
                ...
                data-endelementdelay="0.1" 
                data-endspeed="300" 
                style="z-index: 7; font-size:16px; color:#FFFFFF; font-weight:500; line-height:26px; max-width: auto; max-height: auto; white-space: nowrap;">Improved diagnostic performance and heightened satisfaction of patients <br> and physicians delight.</div>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption sfb tp-resizeme" 
                ...
                data-endspeed="300" 
                data-scrolloffset="0"
                style="z-index: 6; font-size:40px; color:white; font-weight:500; white-space: nowrap;"> Welcome To Our Research Center </div>
            ...
            <div class="tp-caption sfb tp-resizeme text-center" 
                ...
                data-endspeed="300" 
                data-scrolloffset="0"
                style="z-index: 7; font-size:20px; font-weight:500; line-height:26px; color:white; max-width: auto; max-height: auto; white-space: nowrap;">We work in a friendly and efficient using the latest <br>
    ...
    <section class="p-t-b-150">
      <div class="container"> 
        ...
        <div class="heading-block">
          <h2>Our Services</h2>
          <hr>
          <span>These are the Services of our Hospital</span> </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>Get the best eye care treatment </p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>World class Operation Theater facilities</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>Best Icu with all the facilities</p>
                </div>
              </article>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>We also Solve Stomach Problems</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>We have The Highest Qualified Doctors</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>One of the Best hospital for Heart Problems</p>
                </div>
              </article>
            </div>
