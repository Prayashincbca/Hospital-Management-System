            ...
            <div class="menu" style="background-color:#663399">
                <ul class="list" style="overflow: hidden; width: auto; height: calc(-184px + 100vh);">
                    ...
                    <li class="active open"><a href="adminaccount.php"><i
                                class="zmdi zmdi-home"></i><span>Admin Dashboard</span></a></li>
            ...
            <div class="menu" style="background-color:#663399">
                <ul class="list">
                    ...
                    <li class="active open"><a href="doctoraccount.php"><i
                                class="zmdi zmdi-home"></i><span>Doctor Dashboard</span></a></li>
            ...
            <div class="menu" style="background-color:#663399">
                <ul class="list">
                    ...
                    <li class="active open"><a href="patientaccount.php"><i
                                class="zmdi zmdi-home"></i><span>Patient Dashboard</span></a></li>
